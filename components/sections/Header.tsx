      ...
      <main className="lg:w-2/3 w-full mx-auto flex justify-between items-center flex-wrap">
        ...
        shadow-md p-4 transition duration-500 ease-in-out transform-all"
            >
              ...
              <Link href='/events/create' className="text-md hover:text-orange-500 duration-300 transition-all block py-1">
                Create
              </Link>
              <Link href='/events/personal' className="text-md hover:text-orange-500 duration-300 transition-all block py-1">
                Personal
              </Link>
              {/* <ConnectBtn /> */}
            </div>
